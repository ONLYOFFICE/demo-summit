...
Action Scheduler is developed and maintained by [Automattic](https://automattic.com/) with significant early development completed by [Flightless](https://flightless.us/).
